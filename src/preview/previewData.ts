...
export const previewActivitySessions: ActivitySession[] = [
  // two same-day WHOOP swims that were really one session — demonstrates the
  // merge affordance, which only appears on days with 2+ activities
  {
    id: 'act_today_swim_a',
    user_id: PREVIEW_USER_ID,
    ...
    title: null,
    date: PREVIEW_TODAY,
    started_at: iso(at(now, 6, 30)),
    ended_at: iso(at(now, 6, 52)),
    ...
    user_edited: false,
    dismissed_at: null,
    created_at: iso(at(now, 7, 0)),
    updated_at: iso(at(now, 7, 0)),
  },
  {
    id: 'act_today_swim_b',
    user_id: PREVIEW_USER_ID,
    ...
    title: null,
    date: PREVIEW_TODAY,
    started_at: iso(at(now, 6, 58)),
    ended_at: iso(at(now, 7, 14)),
    ...
    user_edited: false,
    dismissed_at: null,
    created_at: iso(at(now, 7, 20)),
    updated_at: iso(at(now, 7, 20)),
  },
  {
    id: 'act_today_bike',
    user_id: PREVIEW_USER_ID,
